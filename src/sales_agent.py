...
class productQuery(BaseModel):
    ...
    intent: Intent | None = Field(
        ...
        get_products: User wants product recommendations or product search or see the products.
...
def buy_agent(query):
    return ["thanks for buyign this product"]

# print(final_prods("show product a5"))
def sales_agent(query, user_id):
    state={
        "message":[],
        "price":None,
        "user_id":user_id,
